...
# usunięcie niepotrzebnych i błędnych danych oraz kolumn
...
# Utworzenie dendogramu w celu zobaczenia odległości pomiędzy rekoradami
...
# Zapisanie modelu dataframe (rozkład i nazwy kolumn)
