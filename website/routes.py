...
def thanks_page():
    ...
    gra_w_ciagu_12_db = db.session.query(db.func.count(Info.gra_w_ciagu_12)).group_by(Info.gra_w_ciagu_12).all()
    gra_w_ciagu_12 = []
    ...
    # NEGATYWNE CECHY
    gra_gniew_db = db.session.query(Games.negatyw_gniew, db.func.count(Games.negatyw_gniew)).group_by(Games.negatyw_gniew).all()
    ...
    negatyw_zaniedbania_db = db.session.query(Games.negatyw_zaniedbania, db.func.count(Games.negatyw_zaniedbania)).group_by(Games.negatyw_gniew).all()
    ...
    negatyw_gra_nad_inne_aktywnosci_db = db.session.query(Games.negatyw_gra_nad_inne_aktywnosci, db.func.count(Games.negatyw_gra_nad_inne_aktywnosci)).group_by(Games.negatyw_gra_nad_inne_aktywnosci).all()
    ...
    pozytyw_koordynacja_db = db.session.query(Games.pozytyw_koordynacja, db.func.count(Games.pozytyw_koordynacja)).group_by(Games.pozytyw_koordynacja).all()
    ...
    pozytyw_samokontrola_db = db.session.query(db.func.count(Games.pozytyw_samokontrola)).group_by(Games.pozytyw_samokontrola).all()
    ...
    pozytyw_koncentracja_db = db.session.query(Games.pozytyw_koncentracja, db.func.count(Games.pozytyw_koncentracja)).group_by(Games.pozytyw_koncentracja).all()
    ...
    gra_prof_db = db.session.query(db.func.count(Games.gra_prof)).group_by(Games.gra_prof).all()
    gra_prof_values = []
    for value, in gra_prof_db:
        gra_prof_values.append(value)

    gra_typ_db = db.session.query(db.func.count(Games.gra_typ)).group_by(Games.gra_typ).all()
    gra_typ_values = []
